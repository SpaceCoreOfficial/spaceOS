...
os.system(command='title spaceOS 5')
def wrong_command():
...
#                                                                                                          \=================================================================/
    ...
    if user == 'help':
        print(Back.YELLOW + '==========================================')
        print(Back.YELLOW + "--------- Welcome to spaceOS 5 -----------")
        print(Back.YELLOW + '==========================================')
        print("\n---------------------------------------------------")
        print("|HELP to help                                     |")
        ...
        print("|TYPE to display the contents of the file         |")
        print("---------------------------------------------------\n")
